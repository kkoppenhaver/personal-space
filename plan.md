...
- ~~**Planet visuals workstream.** Whole separate plan TBD.~~ Plan written 2026-05-23: [docs/plans/2026-05-23-001-feat-planet-visuals-llm-driven-assets-plan.md](docs/plans/2026-05-23-001-feat-planet-visuals-llm-driven-assets-plan.md). LLM-driven asset selection from CC0 + Poly Pizza catalog with hybrid retrieve-then-constrain pipeline.
- ~~**Planet discovery lifecycle review.**~~ Folded into the planet-visuals plan (2026-05-23). The Tier 1 → Tier 2 → Tier 3 pipeline audit is the basis for the redesigned Tier 2 split (direct + pick) covered there.
